...
public class RegionalFlowGraphPathUsingSubPaths
{
    public List<RegionalPathUsingSubPaths> regionalPaths;
    public List<int> unitCounts;
    public List<float> pathFlows;

    public Dictionary<int, PathFlowDivider> regionToFlowDivider;

    public RegionalFlowGraphPathUsingSubPaths(List<(RegionalPathUsingSubPaths regionalPath, float flow, int numberOfUnits)> paths)
    {
        List<List<int>> gatewayOrders = new List<List<int>>();
        regionalPaths = new List<RegionalPathUsingSubPaths>();
